...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const notifications = await notifyPushSubscribers({ platform: "magazine", type: "new_magazine", title: "Nouveau magazine Envol Africa", body: newMag.title, link: `/kiosque/${newMag.id}`, image: newMag.cover, entityType: "magazine", entityId: newMag.id, dedupePrefix: `magazine:${newMag.id}` });
