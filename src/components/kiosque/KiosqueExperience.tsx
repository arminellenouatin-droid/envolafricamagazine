          ...
          <div className="relative mx-auto grid max-w-[1380px] items-center gap-12 px-5 py-12 md:px-10 md:py-20 lg:grid-cols-[.82fr_1.18fr] lg:px-16 lg:py-24">
            ...
            <div className="order-1 flex justify-center lg:order-2 lg:justify-end">
              <div className="kiosque-featured-cover group relative">
                ...
                <div className="relative aspect-[3/4] w-[250px] overflow-hidden bg-white md:w-[355px]"><img src={featured.cover} alt={featured.title} className="h-full w-full object-cover transition duration-1000 group-hover:scale-105" /><div className="absolute inset-0 bg-gradient-to-tr from-black/25 via-transparent to-white/20" /><span className="absolute left-4 top-4 rounded-full bg-[#9e001f] px-3 py-1 font-sans text-[9px] font-bold uppercase tracking-[.14em] text-white">Numéro vedette</span><div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-5 pt-20 text-white"><p className="font-sans text-[10px] uppercase tracking-[.14em] text-white/70">Envol Africa Magazine</p><p className="mt-1 font-serif text-2xl">{featured.title}</p></div></div>
