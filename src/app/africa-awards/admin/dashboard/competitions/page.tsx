...
const statuses = ["draft", "published", "registrations_open", "registrations_closed", "voting_open", "live_scheduled", "voting_closed", "finished", "archived"];
...
export default function AdminCompetitionsPage() {
  ...
  const load = async () => {
    setLoading(true);
    const response = await fetch("/api/awards/competitions", { cache: "no-store" });
