...
export async function POST(request: NextRequest) {
  ...
  if (mimeType.startsWith("video/") && typeof durationSeconds === "number" && durationSeconds > 65) return NextResponse.json({ error: "Une vidéo de Story ne peut pas dépasser 60 secondes." }, { status: 400 });
