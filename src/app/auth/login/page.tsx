    ...
    <main className="min-h-screen bg-[#f7fbfa] px-4 py-10 text-[#082843] md:px-8 md:py-14">
      <div className="mx-auto w-full max-w-[980px]">
        <div className="mb-8 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3" aria-label="Retour à Envol Africa Magazine">
            <img src="/logo-couleur-entete-new.png" alt="Envol Africa Magazine" className="h-8 w-auto object-contain" />
            <span className="hidden text-sm font-black tracking-[0.16em] text-[#082843] sm:inline">ENVOL AFRICA</span>
          </Link>
        ...
        <div className="mx-auto w-full max-w-[460px]">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-2 max-w-[36ch] text-[14px] leading-6 text-[#5b6e72]">Connectez-vous pour accéder à votre espace, vos achats, vos abonnements et vos services.</p>
          </div>
