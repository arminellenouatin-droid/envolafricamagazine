...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const notifications = await notifyPushSubscribers({ platform: "magazine", type: "new_magazine", title: "ENVOL AFRICA", body: newMag.title, link: `/kiosque`, image: newMag.cover, entityType: "magazine", entityId: newMag.id, dedupePrefix: `magazine:${newMag.id}` });
