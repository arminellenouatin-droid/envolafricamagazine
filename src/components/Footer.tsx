    ...
    <footer>
      <div className="border-b border-white/10 bg-[#1b1c1c] px-5 py-10 md:px-[64px]">
        <div className="mx-auto flex max-w-[1280px] flex-col items-start gap-6 md:flex-row">
          <Link href={platform.homeHref} aria-label={`Accueil ${platform.name}`}><img src={platform.logoSrc} alt={platform.logoAlt} className="h-[56px] w-auto object-contain" /></Link>
