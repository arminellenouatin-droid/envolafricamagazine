...
type Campaign = { id: string; budgetXof: number; durationDays: number; targetCountries: string[]; targetIndustries: string[]; status: string; startsAt?: string; endsAt?: string; post: { id?: string; content: string; views: number; likes: number; comments: number } | null };
