              ...
              <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
                <form onSubmit={handleCreateArticle} className="bg-white rounded-[20px] p-6 w-full max-w-[760px] max-h-[90vh] overflow-y-auto">
                  ...
                  <div className="mt-4 grid gap-3">
                    ...
                    <div className="rounded-[16px] border border-zinc-200 bg-zinc-50 p-4"><div className="mb-2 text-xs font-black text-[#0A1931]">Emplacements du Landing Magazine</div><p className="mb-3 text-[11px] leading-5 text-zinc-500">Cochez l’emplacement où cet article doit apparaître. Le premier article coché pour chaque emplacement est retenu.</p><div className="flex flex-wrap gap-3 text-[12px]"><label className="flex items-center gap-2"><input type="checkbox" name="isFeatured" defaultChecked={editingArticle?.isFeatured}/> Carrousel principal</label><label className="flex items-center gap-2"><input type="checkbox" name="isSentinelle" defaultChecked={editingArticle?.isSentinelle}/> Bloc image 1</label><label className="flex items-center gap-2"><input type="checkbox" name="isEssor" defaultChecked={editingArticle?.isEssor}/> Bloc image 2</label><label className="flex items-center gap-2"><input type="checkbox" name="isOmbreDouce" defaultChecked={editingArticle?.isOmbreDouce}/> Bloc image 3</label></div></div>
                  </div>
