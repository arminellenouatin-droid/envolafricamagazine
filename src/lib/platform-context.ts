...
export const PLATFORM_CONTEXTS: Record<PlatformKey, { label: string; accent: string; roles: PlatformRole[] }> = {
  magazine: { label: "Magazine", accent: "#9e001f", roles: [
    ...
    { id: "admin", label: "Administrateur Magazine", dashboardLabel: "Administration Magazine", description: "Piloter les articles, magazines, commandes et abonnements éditoriaux.", links: [{ label: "Administration Magazine", href: "/admin" }, { label: "Commandes", href: "/admin/orders" }] },
  ] },
  marketplace: { label: "Marketplace", accent: "#9e001f", roles: [
    ...
    { id: "admin", label: "Administrateur Marketplace", dashboardLabel: "Administration Marketplace", description: "Contrôler les vendeurs, produits, commandes, commissions, litiges et versements.", links: [{ label: "Marketplace", href: "/marketplace" }, { label: "Administration", href: "/admin" }] },
  ] },
